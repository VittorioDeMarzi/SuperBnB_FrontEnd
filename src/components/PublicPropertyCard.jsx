    ...
    <>
      {property && (
        <Link
          ...
          className="card w-72 hover:shadow-2xl bg-white bg-opacity-40"
        >
          <div className="m-2">
            <figure>
              <div className="relative w-full max-w-md mx-auto">
                ...
                <button
                  ...
                  className="absolute top-1/2 left-2 transform -translate-y-1/2 bg-background bg-opacity-70  p-2 rounded-full text-ocra"
                >
                  &#8592;
                </button>
                ...
                <button
                  ...
                  className="absolute top-1/2 right-2 transform -translate-y-1/2 bg-background bg-opacity-70  p-2 rounded-full text-ocra"
                >
                  &#8594;
                </button>
